...
<div class="max-w-6xl mx-auto px-4 py-4">
    ...
    <div class="rounded-2xl ring-1 ring-white/10 bg-slate-950/40 overflow-hidden flex flex-col"
        ...
        <div class="p-4 border-b border-white/10 flex items-start justify-between gap-3">
            <div>
                <div class="text-base font-semibold">Edit Employee</div>
                <div class="text-xs text-slate-300">
                    Update details and salary structure for {{ $employee->first_name }} {{ $employee->last_name }}.
                </div>
            </div>
        ...
        <form method="POST"
              action="{{ route('modules.payroll.employees.update', $employee->id) }}"
